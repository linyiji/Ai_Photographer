...
|---|---:|---:|---:|---:|---|
| GFTT + PyrLK | 1.000 | 0.979 | 335.1 ms | 0 | **PRIMARY** |
| ORB + BF matching | 0.520 | 0.438 | 651.9 ms | 0 | REFERENCE/FALLBACK |
...
- latest controlled Web two-scenario comparison: 335–652 ms by route (earlier warm-up run: 661–774 ms);
...
- automated suite: 155/155 PASS, including the OPPO-reported full-progress and QUICK→reversed-WIDE regressions;
