...
export function HomeView(props:Props){
 return <View className='homeV1'>
  ...
  {props.notice&&<View className='homeNotice'>{props.notice}</View>}{props.error&&<View className='homeError'>{props.error}</View>}{props.acceptanceHud}
