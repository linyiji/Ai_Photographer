...
export interface SemanticPoseOptions { center_x?:number; scale?:number; confidence?:number; wrist_extension?:'LEFT'|'RIGHT'|null; missing_elbow?:boolean; missing_knee?:boolean; missing_ankle?:boolean; shoulder_confidence_asymmetry?:boolean; hip_confidence_asymmetry?:boolean; shoulder_z_skew?:number; }
...
export function semanticPose(mode:BodyMode,options:SemanticPoseOptions={}):LandmarkSample[]{
  ...
  if(options.shoulder_z_skew&&points[11]&&points[12]){points[11].z=-options.shoulder_z_skew/2;points[12].z=options.shoulder_z_skew/2;}
