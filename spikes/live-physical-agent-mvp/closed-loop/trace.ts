...
export const scalarTraceRow = (state: StructuredPerceptionState, snapshot: ClosedLoopSnapshot, visual?: VisualGuidanceState | null, themeId?: string): ScalarTraceRow => ({
  ...
  ...(state.framing?{semantic_framing:{body_mode:state.framing.body_mode,body_mode_confidence:state.framing.body_mode_confidence,anchor_x:state.framing.anchor_x,anchor_x_source:state.framing.anchor_x_source,scale:state.framing.scale,scale_metric_type:state.framing.scale_metric_type,uncertainty_x:state.framing.uncertainty_x,uncertainty_scale:state.framing.uncertainty_scale,valid_for_precision_x:state.framing.valid_for_precision_x,valid_for_precision_scale:state.framing.valid_for_precision_scale,cropped_edges:{...state.framing.cropped_edges},filter_type:state.framing.filter_type,body_mode_transition_count:state.framing.body_visibility.body_mode_transition_count,body_mode_flicker_count:state.framing.body_visibility.body_mode_flicker_count}}:{}),
