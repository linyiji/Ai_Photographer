...
export interface V3Episode {
  ...
  action: V3Action;
  issued_at: number;
  movement_started_at: number | null;
  meaningful_motion_at: number | null;
  settle_detected_at: number | null;
  settled_measurement_at: number | null;
  outcome_at: number | null;
  start_state_version: number;
  settled_state_version: number | null;
  start_relation: V3FramingRelation | V3XRelation;
